  ...
  return (
    <div style={{ paddingTop: 64 }}>
      ...
      {!showSuppressed && suppressedCount > 0 && (
        <div style={{ fontFamily: FONT_MONO, fontSize: 11.5, color: 'rgba(232,234,242,.38)', marginTop: 12 }}>
        ...
        {entries.map((a, i) => (
          ...
          >
            ...
            >
              ...
              <span style={{ fontFamily: FONT_MONO, fontSize: 11, color: 'rgba(232,234,242,.36)' }}>
