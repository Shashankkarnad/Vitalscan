        ...
        <div style={{ maxWidth: 480, width: '100%' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ ...kicker, textAlign: 'center', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(232,234,242,.42)' }}>
          ...
          <div style={{ ...card(16), padding: 24, display: 'flex', flexDirection: 'column', gap: 20, ...rise(0.18) }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 9,
                padding: '13px 16px',
                border: `1px solid ${!file || loading ? 'rgba(255,255,255,.08)' : 'rgba(255,255,255,.14)'}`,
                background: !file || loading ? 'rgba(255,255,255,.02)' : 'rgba(255,255,255,.06)',
                color: !file || loading ? 'rgba(232,234,242,.32)' : INK,
