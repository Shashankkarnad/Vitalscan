...
export default function ContractNotice() {
  return (
    ...
    >
      ...
      <h2 style={{ fontSize: 19, fontWeight: 600, margin: '16px 0 0', letterSpacing: '-.01em', color: '#e8eaf2' }}>
        Re-upload your export to unlock the new dashboard.
      </h2>
      <p style={{ fontSize: 15, lineHeight: 1.6, color: 'rgba(232,234,242,.66)', margin: '10px 0 0', maxWidth: 640 }}>
        ...
        <a href="/results" style={{ color: 'rgba(232,234,242,.85)' }}>
          Results
        </a>
        .
      </p>
